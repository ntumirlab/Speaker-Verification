...
class DeepSpeakerModel(nn.Module):
    def __init__(self, embedding_size, num_classes):
        ...
        self.alpha = 10
        self.model = myResNet(BasicBlock, [3, 4, 6, 3])
        self.fc1 = nn.Linear(2048, 512)
        self.fc2 = nn.Linear(512, self.embedding_size)

        self.classifier = nn.Linear(self.embedding_size, num_classes)
        # self.model.classifier = AngularPenaltySMLoss(self.embedding_size, num_classes)
...
if __name__ == "__main__":
    ...
    model = DeepSpeakerModel(num_classes=340, embedding_size=64)
    x = model(x)
    # print(x.shape)
