...
class GE2ELoss(nn.Module):
    ...
    def __init__(self, init_w=10.0, init_b=-5.0, loss_method='softmax'):
        ...
        self.w = nn.Parameter(torch.as_tensor(init_w, dtype=torch.float))
        self.b = nn.Parameter(torch.as_tensor(init_b, dtype=torch.float))
        # self.w = torch.tensor(init_w)
        # self.b = torch.tensor(init_b)
