...
class FTDNN(nn.Module):
    ...
    def __init__(self, num_classes, embedding_size=512, in_dim=30):
        '''
        ...
        self.layer12 = DenseReLU(4096, self.embedding_size)
...
if __name__ == "__main__":
    print("go")
    t = torch.randn(10, 1000, 64)
    xvector = FTDNN(num_classes=100, in_dim=64)
    out = xvector(t)
    print(out.shape)
    # num_of_frames = 100
    # hop_size = 50
    # end = (532 - num_of_frames + hop_size) // num_of_frames * num_of_frames
    # print(end)