...
if __name__ == "__main__":
    data_dir = "/mnt/E/arthur.wang/SRE10/mfcc/data/phonecall/tel/test"

    f = iglob(f"{data_dir}/*/*.pkl")

    speaker_dic = {}

    for path in tqdm(f, total=55533):
    ...
    with open(f"/mnt/E/arthur.wang/SRE10/sre_test_list.txt", 'w') as w:
