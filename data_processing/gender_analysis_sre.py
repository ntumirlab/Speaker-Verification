...
def split_gender(scores, labels):
    ...
    same_labels = []
    different_labels = []
    meta_path = f"/mnt/E/arthur.wang/SRE10/wav/train/8conv.trn"
    ...
    for line in tqdm(meta, desc="reading meta..."):
        ...
        speaker_dic[line[0]] = {}
        speaker_dic[line[0]]["gender"] = line[1]
...
metrics_path = "/mnt/E/arthur.wang/metrics/deepspeaker/sre10/8_normalize_logfbank"
# metrics_path = "/mnt/E/arthur.wang/metrics/deepspeaker/sre10/8_normalize_fbank"
test_input_per_file = 8
test_list_path = "/mnt/E/arthur.wang/SRE10/sre_test_list.txt"
