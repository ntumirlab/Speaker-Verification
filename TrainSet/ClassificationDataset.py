...
class ClassificationDataset(data.Dataset):
    ...
    def __init__(self, utt_dir, iterations, batch_size=32, random_window=False, oneD=False, normalize=False, std=False, static=False, *arg, **kw):
    ...
    def __getitem__(self, index):
        ...
        if self.static:
            ...
            return self.static_features[index]
    ...
    def get_static_features(self,):
        ...
        for _ in tqdm(range(4500), desc="getting static features....."):
            ...
            static_feature.append((frames, spkrs))
        return static_feature*10
